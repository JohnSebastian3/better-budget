    ...
    <section id="main__description" className={style["main__description"]}>
      <div className="container">
        <div className={style["main__description-content"]}>
          ...
          ></TbDeviceDesktopAnalytics>
          <h2>How It Works</h2>
          <div className={style["main__description-step"]}>
            <h3>Create an account for free</h3>
            <p>
              BetterBudget is free to use and always will be. You can{" "}
              <Link
                to={"/register"}
                className={style["main__description-link"]}
              >
                start your budgeting journey
              </Link>{" "}
              without ever having to take out your wallet.
            </p>
          </div>
